...
export class Preload extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('mole1', 'image/mole-1.png');
        this.load.image('mole2', 'image/mole-2.png');
        this.load.image('mole3', 'image/mole-3.png');
        this.load.image('mole4', 'image/mole-4.png');

        // Load sound
        this.load.audio('background', 'audio/background.mp3');
        this.load.audio('whackSound', 'audio/whack-sound.mp3');
